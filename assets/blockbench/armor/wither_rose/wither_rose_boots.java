...
public class solar_eclipse_leona extends EntityModel<Entity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData left_boot = left_leg.addChild("left_boot", ModelPartBuilder.create().uv(22, 116).cuboid(-2.5F, 5.5F, -2.6F, 5.0F, 7.0F, 5.0F, new Dilation(0.25F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData right_leg = modelPartData.addChild("right_leg", ModelPartBuilder.create(), ModelTransform.pivot(-2.0F, 12.0F, 0.0F));

		ModelPartData right_boot = right_leg.addChild("right_boot", ModelPartBuilder.create().uv(0, 116).cuboid(-2.5F, 5.5F, -2.5F, 5.0F, 7.0F, 5.0F, new Dilation(0.25F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
