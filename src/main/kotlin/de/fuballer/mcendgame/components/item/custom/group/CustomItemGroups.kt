...
import de.fuballer.mcendgame.components.item.custom.tools.CustomToolItems
...
object CustomItemGroups {
    ...
    val CUSTOM_TOOLS_KEY = RegistryKey.of(Registries.ITEM_GROUP.key, IdentifierUtil.default("custom_tools"))
    val CUSTOM_TOOLS = RegistryUtil.registerItemGroup(
        CUSTOM_TOOLS_KEY, FabricItemGroup.builder()
            ...
            .displayName(Text.translatable("itemGroup.custom_tools"))
    )
