...
enum class Boots(
    ...
    override val rollableCustomAttributes = listOf(
        ...
        RandomOption(
            weight = 1,
            listOf(
                LevelLockedRandomOption(weight = 50, tier = 1, level = 0, RollableCustomAttribute(VanillaAttributeTypes.INCREASED_MOVEMENT_SPEED, 3, DoubleBounds(0.05, 0.15))),
                LevelLockedRandomOption(weight = 10, tier = 2, level = 5, RollableCustomAttribute(VanillaAttributeTypes.INCREASED_MOVEMENT_SPEED, 2, DoubleBounds(0.15, 0.25))),
                LevelLockedRandomOption(weight = 1, tier = 3, level = 10, RollableCustomAttribute(VanillaAttributeTypes.INCREASED_MOVEMENT_SPEED, 1, DoubleBounds(0.25, 0.35))),
            )
        ),
    )
