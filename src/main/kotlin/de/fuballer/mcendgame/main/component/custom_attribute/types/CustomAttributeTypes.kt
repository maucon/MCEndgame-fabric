...
object CustomAttributeTypes {
    ...
    val MORE_DAMAGE_TAKEN = CustomAttributeType("more_damage_taken", AttributeFormats.PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.MORE)
    ...
    val INCREASED_DAMAGE = CustomAttributeType("increased_damage", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.INCREASED)
    val MORE_DAMAGE = CustomAttributeType("more_damage", AttributeFormats.PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.MORE)
    val MORE_DAMAGE_PER_MISSING_HEART = CustomAttributeType("more_damage_per_missing_heart", AttributeFormats.PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.MORE)
    val INCREASED_ELEMENTAL_DAMAGE = CustomAttributeType("increased_elemental_damage", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.INCREASED)
    val INCREASED_PROJECTILE_DAMAGE = CustomAttributeType("increased_projectile_damage", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.INCREASED)
    ...
    val INCREASED_DAMAGE_AGAINST_FULL_HEALTH = CustomAttributeType(
        "increased_damage_against_full_health", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS,
        SignBasedKeywords.INCREASED
    )
    val INCREASED_DAMAGE_WHILE_LOW_HEALTH =
        CustomAttributeType("increased_damage_while_low_health", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.INCREASED)
    val MORE_DAMAGE_TAKEN_WHILE_HIGH_HEALTH =
        CustomAttributeType("more_damage_taken_while_high_health", AttributeFormats.PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.MORE)

    // POISON
    val INCREASED_DAMAGE_WHILE_POISONED =
        CustomAttributeType("increased_damage_while_poisoned", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.INCREASED)
    val INCREASED_ATTACK_DAMAGE_WHILE_POISONED = CustomAttributeType(
        "increased_attack_damage_while_poisoned", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS,
        SignBasedKeywords.INCREASED
    )
    val INCREASED_ELEMENTAL_DAMAGE_WHILE_POISONED = CustomAttributeType(
        "increased_elemental_damage_while_poisoned", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS,
        SignBasedKeywords.INCREASED
    )
    val MORE_DAMAGE_TAKEN_WHILE_POISONED =
        CustomAttributeType("more_damage_taken_while_poisoned", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.MORE)
    ...
    val INCREASED_MOVEMENT_SPEED_WHILE_POISONED = CustomAttributeType(
        "increased_movement_speed_while_poisoned", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS,
        SignBasedKeywords.INCREASED
    )
    ...
    val INCREASED_DAMAGE_WHILE_WITHERED =
        CustomAttributeType("increased_damage_while_withered", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.INCREASED)
    val INCREASED_ATTACK_DAMAGE_WHILE_WITHERED = CustomAttributeType(
        "increased_attack_damage_while_withered", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS,
        SignBasedKeywords.INCREASED
    )
    ...
    val INCREASED_MOVEMENT_SPEED_AFTER_DODGING =
        CustomAttributeType("increased_movement_speed_after_dodging", AttributeFormats.SIGNED_PERCENT_AND_INT_ROLL, AttributeFormats.PERCENT_AND_INT_BOUNDS, SignBasedKeywords.INCREASED)

    val MORE_ATTACK_KNOCKBACK = CustomAttributeType("more_attack_knockback", AttributeFormats.PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.MORE)
    ...
    val INCREASED_HEALING_RECEIVED = CustomAttributeType("increased_healing_received", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.INCREASED)
    val MORE_HEALING_RECEIVED = CustomAttributeType("more_healing_received", AttributeFormats.PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS, SignBasedKeywords.MORE)
