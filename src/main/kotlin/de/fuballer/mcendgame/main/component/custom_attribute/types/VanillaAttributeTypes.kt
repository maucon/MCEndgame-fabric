...
object VanillaAttributeTypes {
    ...
    val MAX_HEALTH =
        VanillaAttributeType(EntityAttributes.MAX_HEALTH, EntityAttributeModifier.Operation.ADD_VALUE, "max_health", AttributeFormats.SIGNED_DOUBLE_ROLL, AttributeFormats.DOUBLE_BOUNDS)
    ...
    val INCREASED_ATTACK_SPEED = VanillaAttributeType(
        EntityAttributes.ATTACK_SPEED, EntityAttributeModifier.Operation.ADD_MULTIPLIED_BASE, "increased_attack_speed", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS,
        SignBasedKeywords.INCREASED
    )
    ...
    val INCREASED_SCALE = VanillaAttributeType(
        EntityAttributes.SCALE, EntityAttributeModifier.Operation.ADD_MULTIPLIED_BASE, "increased_scale", AttributeFormats.SIGNED_PERCENT_ROLL, AttributeFormats.PERCENT_BOUNDS,
        SignBasedKeywords.INCREASED
    )
