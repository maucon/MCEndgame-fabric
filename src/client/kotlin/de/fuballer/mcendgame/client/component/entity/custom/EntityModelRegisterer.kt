...
object EntityModelRegisterer {
    ...
    fun register() {
        ...
        EntityRendererRegistry.register(CustomEntities.BONECRUSHER) { state ->
            BonecrusherRenderer<de.fuballer.mcendgame.client.component.entity.custom.entities.bonecrusher.BonecrusherRenderState>(
                state
            )
        }
