...
class DefaultPortalRenderType : PortalRenderType {
    ...
    override fun getRenderLayer(renderer: PortalRenderer, state: de.fuballer.mcendgame.client.component.entity.custom.entities.portal.PortalRenderState, showBody: Boolean, translucent: Boolean, showOutline: Boolean): RenderLayer {
