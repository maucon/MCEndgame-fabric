...
interface PortalRenderType {
    ...
    fun getModel(context: EntityRendererFactory.Context): EntityModel<de.fuballer.mcendgame.client.component.entity.custom.entities.portal.PortalRenderState>
    fun getRenderLayer(renderer: PortalRenderer, state: de.fuballer.mcendgame.client.component.entity.custom.entities.portal.PortalRenderState, showBody: Boolean, translucent: Boolean, showOutline: Boolean): RenderLayer? = null
