...
class AbyssalMaskModel<S : BipedEntityRenderState>(
    root: ModelPart
) : BipedEntityModel<S>(root) {
    companion object {
        val MODEL_LAYER = EntityModelLayer(IdentifierUtil.default("abyssal_mask"), "main")
        ...
        fun getTexturedModelData(): TexturedModelData {
            ...
            val helmet = head.addChild(
                "helmet", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, Dilation(0.25F))
                    .uv(0, 16).cuboid(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, Dilation(0.5F)), ModelTransform.origin(0.0F, 0.0F, 0.0F)
            )
