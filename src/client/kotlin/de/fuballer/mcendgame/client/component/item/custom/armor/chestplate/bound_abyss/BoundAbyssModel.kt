...
class BoundAbyssModel<S : BipedEntityRenderState>(
    ...
    override fun getVertexConsumer(
        ...
        if (renderState !is de.fuballer.mcendgame.client.accessor.LivingEntityRenderStateAccessor) return default
    ...
    private fun setLowHealthAngles(renderState: S) {
        val accessor = renderState as? de.fuballer.mcendgame.client.accessor.LivingEntityRenderStateAccessor ?: return
