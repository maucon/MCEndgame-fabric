package de.fuballer.mcendgame.components.item.custom.armor.chestplate.druids_chestplate
...
class DruidsChestplateModel<S : BipedEntityRenderState>(
    ...
    companion object {
        ...
        fun getTexturedModelData(): TexturedModelData {
            ...
            val chestplate =
                body.addChild("chestplate", ModelPartBuilder.create(), ModelTransform.pivot(0.0f, 0.0f, 0.0f))
